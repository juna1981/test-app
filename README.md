...
To add or edit a category, preserve the documented category shape. Category keys are read dynamically by `index.js`, so a new category is included in the menu without a separate code registration step.
